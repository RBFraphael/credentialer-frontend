...
export default function NewProject()
{
    ...
    const onSubmit = (e: FormEvent) => {
        ...
        PrivateApi.post("/project", payload).then((res: AxiosResponse) => {
            Swal.fire({
                icon: "success",
                title: "Sucesso",
                html: `O projeto <b>${project.title}</b> foi adicionado com sucesso.`
            }).then(() => {
                router.push(`/clients/${clientId}/projects`);
            });
        }).catch((error: Error | AxiosError) => {
            let message: string = "Ocorreu um erro durante o cadastro do projeto";
                ...
                <div className="row">
                    <div className="col-12">
                        <h1>
                            ...
                            </button> Novo Projeto do Cliente &quot;{client.name}&quot;
                        </h1>
                        <hr />
                    </div>
                </div>
                                        ...
                                        <div className="col-12">
                                            { submitting ? (
                                                ...
                                                <button type="submit" className="btn btn-success shadow-sm">
                                                    <FontAwesomeIcon icon={faSave} fixedWidth /> Adicionar Projeto
                                                </button>
                                            )}
                                        </div>
                                    </div>
